...
export default function EditCropPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`http://localhost:8000/api/update/crop/${id}`, {
                ...
                nitrogenRequired: crop.nitrogenRequired,
                phosphorusRequired: crop.phosphorusRequired,
                potassiumRequired: crop.potassiumRequired,
                ...
                <main className="p-6">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Update {crop.cropName} Crop</h1>
                                <p className="text-slate-600 dark:text-slate-400">Update {crop.cropName} to the database</p>
                            </div>
                        </div>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="flex gap-4 pt-6">
                                        <Button type="submit" disabled={isLoading} className="bg-emerald-600 hover:bg-emerald-700">
                                            ...
                                            {isLoading ? "Updating.... Crop..." : "Update Crop"}
                                        </Button>
