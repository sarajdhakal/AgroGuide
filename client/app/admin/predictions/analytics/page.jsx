      ...
      <div className={`transition-all duration-300 ${sidebarOpen ? "ml-72" : "ml-16"}`}>
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-between items-start">
            <div>
              <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Prediction Analytics</h1>
              <p className="text-slate-600 dark:text-slate-400">Comprehensive insights into your prediction data</p>
            </div>
            ...
            <CardContent>
              <div className="space-y-4">
                {predictions.slice(0, 5).map((prediction) => {
                  const user = users.find((u) => u._id === prediction.userId) || { firstName: "Unknown", lastName: "User" }
